...
namespace EventosTec.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("Cristopher", "Aquino", "admin@adminmail.com", "664 123 45 67",
                 "Admin");
            var customer = await CheckUserAsync("Antonio", "Miranda", "cliente@clientemail.com", "664 987 65 43",
                 "Client");
